...
# send the cache to store things under the brms cache dir which gets
# persistency on the runner
dir.create(file.path(brms_cache_dir, "tte"), FALSE)
##knitr::opts_chunk$set(cache=TRUE, cache.path = file.path(brms_cache_dir, "tte"))
```
